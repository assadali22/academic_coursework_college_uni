...
public:
	...
	//the list. Postcondition: Returns the value of length.
	...
	//the item in the list at the position specified by location.
	//Postcondition: Returns true if the list[location]
	//is the same as item; otherwise, returns false.
	...
	//location in the array where the item is found; otherwise, returns -1.
