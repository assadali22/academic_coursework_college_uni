...
{
    //personType::print(); //this should print data members from personType? should be easier so you don't have to call all the getters
    cout << "-------------------------------------" << endl;
    cout << "First name: " << personType::getFirstName() << endl;
    cout << "Last name: " << personType::getLastName() << endl;
    cout << "Address: " << personType::getAddress() << endl;
    cout << "Height: " << personType::getHeight() << endl;
    cout << "Date of Birth: " << personType::getDOB() << endl;
    cout << "Gender: " << personType::getGender() << endl << endl;
