...
private:
   ...
   */
  //Reference/Inspiration: https://github.com/sumersao/Data-Structures-and-Algorithms/blob/master/Hashing/LinearProbingHashTable.h
  //used as a starting point for declaring variables along with setting up the constructor
  //the rest of the other hashing methods I was able to complete on my own following
  //the logic of the slide deck for hashing
  vector<int> table;
  HashFunction h;
  int tableSize;
